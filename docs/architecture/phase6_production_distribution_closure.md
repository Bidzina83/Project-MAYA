...
release-bundle generation, signed update and rollback verification, platform
support boundary reporting, package verification, and tests.
...
| 3. Windows desktop release tooling | `scripts/build_phase6_release.py`, `scripts/verify_phase6_release.py` |
...
- The release verifier checks SBOM, provenance, checksums, installer-bundle
  boundaries, and built-artifact installation.
